...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['upload_detailed_location_plan'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_complete_building_layout_plan'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_declaration_certificate'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_water_tank_plan'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['upload_property_google_location_with_coordinates'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.jpeg,.pdf",
			"limit" => "1",
			"filesize" => "3",
