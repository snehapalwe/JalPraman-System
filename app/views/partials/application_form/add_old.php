                                                                            ...
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <div id="ctrl-length_of_ug_tank_proposed-holder" class=""> 
                                                                                        <input id="ctrl-length_of_ug_tank_proposed"  value="<?php  echo $this->set_field_value('length_of_ug_tank_proposed',""); ?>" type="text" placeholder="Enter LENGTH OF UG TANK PROPOSED"  required="" name="length_of_ug_tank_proposed"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div id="ctrl-width_of_ug_tank_proposed-holder" class=""> 
                                                                                            <input id="ctrl-width_of_ug_tank_proposed"  value="<?php  echo $this->set_field_value('width_of_ug_tank_proposed',""); ?>" type="text" placeholder="Enter WIDTH OF UG TANK PROPOSED"  required="" name="width_of_ug_tank_proposed"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div id="ctrl-depth_of_ug_tank_proposed-holder" class=""> 
                                                                                                <input id="ctrl-depth_of_ug_tank_proposed"  value="<?php  echo $this->set_field_value('depth_of_ug_tank_proposed',""); ?>" type="text" placeholder="Enter DEPTH OF UG TANK PROPOSED"  required="" name="depth_of_ug_tank_proposed"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div id="ctrl-length_of_oh_tank_proposed-holder" class=""> 
                                                                                                        <input id="ctrl-length_of_oh_tank_proposed"  value="<?php  echo $this->set_field_value('length_of_oh_tank_proposed',""); ?>" type="text" placeholder="Enter LENGTH OF OH TANK PROPOSED"  required="" name="length_of_oh_tank_proposed"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-group ">
                                                                                                        ...
                                                                                                        <div id="ctrl-width_of_oh_tank_proposed-holder" class=""> 
                                                                                                            <input id="ctrl-width_of_oh_tank_proposed"  value="<?php  echo $this->set_field_value('width_of_oh_tank_proposed',""); ?>" type="text" placeholder="Enter WIDTH OF OH TANK PROPOSED"  required="" name="width_of_oh_tank_proposed"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div id="ctrl-height_of_oh_tank_proposed-holder" class=""> 
                                                                                                                <input id="ctrl-height_of_oh_tank_proposed"  value="<?php  echo $this->set_field_value('height_of_oh_tank_proposed',""); ?>" type="text" placeholder="Enter HEIGHT OF OH TANK PROPOSED"  required="" name="height_of_oh_tank_proposed"  class="form-control " />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div id="ctrl-distance_of_ug_tank_from_supply_line-holder" class=""> 
                                                                                                                        <input id="ctrl-distance_of_ug_tank_from_supply_line"  value="<?php  echo $this->set_field_value('distance_of_ug_tank_from_supply_line',""); ?>" type="text" placeholder="Enter DISTANCE OF UG TANK FROM SUPPLY LINE"  required="" name="distance_of_ug_tank_from_supply_line"  class="form-control " />
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                    <div class="form-group ">
                                                                                                        ...
                                                                                                        <div class="row ">
                                                                                                            <div class="col-md-12 comp-grid">
                                                                                                                <div class=""><script>
                                                                                                                    ...
                                                                                                                    let res = parseInt(residences.value) || 0;
                                                                                                                    let shp = parseInt(shops.value) || 0;
                                                                                                                    let off = parseInt(offices.value) || 0;
                                                                                                                    total.value = res + shp + off;
                                                                                                                    }
