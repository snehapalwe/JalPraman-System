...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Water Form Details Oc</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("water_form_details_oc/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <input id="ctrl-rec_id"  value="<?php  echo $data['rec_id']; ?>" type="hidden" placeholder="Enter Rec Id"  required="" name="rec_id"  class="form-control " />
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-application_no-holder" class=""> 
                                            <input id="ctrl-application_no"  value="<?php  echo $data['application_no']; ?>" type="text" placeholder="Enter APPLICATION NO."  required="" name="application_no"  class="form-control " />
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-diameter-holder" class=""> 
                                                    <input id="ctrl-diameter"  value="<?php  echo $data['diameter']; ?>" type="number" placeholder="Enter DIAMETER (IN MM)" step="0.001"  required="" name="diameter"  class="form-control " />
                                                    </div>
                                                </div>
                                                <div class="form-group ">
