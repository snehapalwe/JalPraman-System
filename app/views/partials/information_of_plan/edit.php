...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Information Of Plan</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("information_of_plan/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div id="ctrl-available_diameter-holder" class=""> 
                                                            <input id="ctrl-available_diameter"  value="<?php  echo $data['available_diameter']; ?>" type="text" placeholder="Enter AVAILABLE DIAMETER (IN MM)"  required="" name="available_diameter"  class="form-control " />
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            ...
                                                            <div id="ctrl-available_pressure-holder" class=""> 
                                                                <input id="ctrl-available_pressure"  value="<?php  echo $data['available_pressure']; ?>" type="text" placeholder="Enter AVAILABLE PRESSURE (KG/CM²)"  required="" name="available_pressure"  class="form-control " />
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                ...
                                                                <div id="ctrl-distance_of_property_from_main_supply_line-holder" class=""> 
                                                                    <input id="ctrl-distance_of_property_from_main_supply_line"  value="<?php  echo $data['distance_of_property_from_main_supply_line']; ?>" type="number" placeholder="Enter Distance Of Property From Main Supply Line" step="any"  required="" name="distance_of_property_from_main_supply_line"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div id="ctrl-proposed_diameter-holder" class=""> 
                                                                                    <input id="ctrl-proposed_diameter"  value="<?php  echo $data['proposed_diameter']; ?>" type="text" placeholder="Enter PROPOSED DIAMETER (IN MM)"  required="" name="proposed_diameter"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <div id="ctrl-proposed_length-holder" class=""> 
                                                                                        <input id="ctrl-proposed_length"  value="<?php  echo $data['proposed_length']; ?>" type="text" placeholder="Enter PROPOSED LENGTH (IN METER)"  required="" name="proposed_length"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div id="ctrl-approximate_cost_of_required_w_s_network_line-holder" class=""> 
                                                                                            <input id="ctrl-approximate_cost_of_required_w_s_network_line"  value="<?php  echo $data['approximate_cost_of_required_w_s_network_line']; ?>" type="text" placeholder="Enter Approximate Cost Of Required W S Network Line"  required="" name="approximate_cost_of_required_w_s_network_line"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div id="ctrl-additional_sump_and_pump_house_of_society-holder" class=""> 
                                                                                                <input id="ctrl-additional_sump_and_pump_house_of_society"  value="<?php  echo $data['additional_sump_and_pump_house_of_society']; ?>" type="text" placeholder="Enter ADDITIONAL SUMP AND PUMP HOUSE OF SOCIETY"  required="" name="additional_sump_and_pump_house_of_society"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div id="ctrl-extending_or_laying_new_pipe_lines_of-holder" class=""> 
                                                                                                    <input id="ctrl-extending_or_laying_new_pipe_lines_of"  value="<?php  echo $data['extending_or_laying_new_pipe_lines_of']; ?>" type="text" placeholder="Enter EXTENDING OR LAYING NEW PIPE LINES OF"  required="" name="extending_or_laying_new_pipe_lines_of"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                            </fieldset>
                                                                                        </div>
