...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Information Of Plan Oc</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-application_no">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['application_no']; ?>" 
                                                ...
                                                data-url="<?php print_link("information_of_plan_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-available_diameter">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['available_diameter']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("information_of_plan_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-available_pressure">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['available_pressure']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("information_of_plan_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-distance_of_property_from_main_supply_line">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                ...
                                                data-title="Enter DISTANCE OF PROPERTY FROM MAIN SUPPLY LINE  (METER)" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="number" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-proposed_diameter">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['proposed_diameter']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("information_of_plan_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-proposed_length">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['proposed_length']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("information_of_plan_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <?php if($can_edit){ ?>
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("information_of_plan_oc/edit/$rec_id"); ?>">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <?php } ?>
                                                <?php if($can_delete){ ?>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("information_of_plan_oc/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
