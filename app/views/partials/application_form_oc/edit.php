...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Application Form Oc</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("application_form_oc/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-licensed_architect_or_engineers_name-holder" class=""> 
                                            <input id="ctrl-licensed_architect_or_engineers_name"  value="<?php  echo $data['licensed_architect_or_engineers_name']; ?>" type="text" placeholder="Enter LICENSED ARCHITECT OR ENGINEERS NAME"  required="" name="licensed_architect_or_engineers_name"  class="form-control " />
                                            </div>
                                        </div>
                                    <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div id="ctrl-proposed_quantity_of_residences-holder" class=""> 
                                                                        <input id="ctrl-proposed_quantity_of_residences"  value="<?php  echo $data['proposed_quantity_of_residences']; ?>" type="number" placeholder="Enter PROPOSED WATER REQUIREMENT FOR RESIDENCES (IN LITRE)" step="1"  required="" name="proposed_quantity_of_residences"  class="form-control " />
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div id="ctrl-proposed_quantity_of_shops-holder" class=""> 
                                                                            <input id="ctrl-proposed_quantity_of_shops"  value="<?php  echo $data['proposed_quantity_of_shops']; ?>" type="number" placeholder="Enter PROPOSED WATER REQUIREMENT FOR SHOPS (IN LITRE)" step="1"  required="" name="proposed_quantity_of_shops"  class="form-control " />
                                                                            </div>
                                                                            <small class="form-text"><span class='text-danger'>Enter Only the Numeric Value</span></small>
                                                                        </div>
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div id="ctrl-proposed_quantity_of_offices-holder" class=""> 
                                                                                <input id="ctrl-proposed_quantity_of_offices"  value="<?php  echo $data['proposed_quantity_of_offices']; ?>" type="number" placeholder="Enter PROPOSED WATER REQUIREMENT FOR OFFICES (IN LITRE)" step="1"  required="" name="proposed_quantity_of_offices"  class="form-control " />
                                                                                </div>
                                                                                <small class="form-text"><span class='text-danger'>Enter Only the Numeric Value</span></small>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div id="ctrl-total-holder" class=""> 
                                                                                    <input id="ctrl-total"  value="<?php  echo $data['total']; ?>" type="text" placeholder="Enter TOTAL QUANTITY OF WATER REQUIRED (IN LITRE) "  readonly required="" name="total"  class="form-control " />
                                                                                    </div>
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <div id="ctrl-length_of_ug_tank_proposed-holder" class=""> 
                                                                                        <input id="ctrl-length_of_ug_tank_proposed"  value="<?php  echo $data['length_of_ug_tank_proposed']; ?>" type="number" placeholder="Enter LENGTH OF UG TANK PROPOSED" step="0.001"  required="" name="length_of_ug_tank_proposed"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div id="ctrl-width_of_ug_tank_proposed-holder" class=""> 
                                                                                            <input id="ctrl-width_of_ug_tank_proposed"  value="<?php  echo $data['width_of_ug_tank_proposed']; ?>" type="number" placeholder="Enter WIDTH OF UG TANK PROPOSED" step="0.001"  required="" name="width_of_ug_tank_proposed"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div id="ctrl-depth_of_ug_tank_proposed-holder" class=""> 
                                                                                                <input id="ctrl-depth_of_ug_tank_proposed"  value="<?php  echo $data['depth_of_ug_tank_proposed']; ?>" type="number" placeholder="Enter DEPTH OF UG TANK PROPOSED" step="0.001"  required="" name="depth_of_ug_tank_proposed"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div id="ctrl-length_of_oh_tank_proposed-holder" class=""> 
                                                                                                        <input id="ctrl-length_of_oh_tank_proposed"  value="<?php  echo $data['length_of_oh_tank_proposed']; ?>" type="number" placeholder="Enter LENGTH OF OH TANK PROPOSED" step="0.001"  required="" name="length_of_oh_tank_proposed"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-group ">
                                                                                                        ...
                                                                                                        <div id="ctrl-width_of_oh_tank_proposed-holder" class=""> 
                                                                                                            <input id="ctrl-width_of_oh_tank_proposed"  value="<?php  echo $data['width_of_oh_tank_proposed']; ?>" type="number" placeholder="Enter WIDTH OF OH TANK PROPOSED" step="0.001"  required="" name="width_of_oh_tank_proposed"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div id="ctrl-height_of_oh_tank_proposed-holder" class=""> 
                                                                                                                <input id="ctrl-height_of_oh_tank_proposed"  value="<?php  echo $data['height_of_oh_tank_proposed']; ?>" type="number" placeholder="Enter HEIGHT OF OH TANK PROPOSED" step="0.001"  required="" name="height_of_oh_tank_proposed"  class="form-control " />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div id="ctrl-distance_of_ug_tank_from_supply_line-holder" class=""> 
                                                                                                                        <input id="ctrl-distance_of_ug_tank_from_supply_line"  value="<?php  echo $data['distance_of_ug_tank_from_supply_line']; ?>" type="text" placeholder="Enter DISTANCE OF UG TANK FROM SUPPLY LINE (IN METRE)"  required="" name="distance_of_ug_tank_from_supply_line"  class="form-control " />
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                    <div class="form-group ">
                                                                                                                                ...
                                                                                                                                <div class="form-group ">
                                                                                                                                    ...
                                                                                                                                    <div id="ctrl-upload_declaration_certificate-holder" class=""> 
                                                                                                                                        <div class="dropzone required" input="#ctrl-upload_declaration_certificate" fieldname="upload_declaration_certificate"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.jpeg,.pdf" filesize="3" maximum="1">
                                                                                                                                            <input name="upload_declaration_certificate" id="ctrl-upload_declaration_certificate" required="" class="dropzone-input form-control" value="<?php  echo $data['upload_declaration_certificate']; ?>" type="text"  />
                                                                                                                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                        <?php Html :: uploaded_files_list($data['upload_declaration_certificate'], '#ctrl-upload_declaration_certificate'); ?>
