...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><STRONG style='color: black;'>WATER TECHNICAL NOC APPLICATION FORM OC</STRONG></h4>
                </div>
                <!--<div class="col-sm-3 ">-->
                <!--    <?php if($can_add){ ?>-->
                <!--    <a  class="btn btn btn-primary my-1" href="<?php print_link("application_form_oc/add") ?>">-->
                <!--        <i class="fa fa-plus"></i>                              -->
                <!--        Add New Application Form Oc -->
                <!--    </a>-->
                <!--    <?php } ?>-->
                <!--</div>-->
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('application_form_oc'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('application_form_oc'); ?>">
        ...
        <?php if(USER_ROLE!=2){ ?>
        <center>
            <a href="<?php echo SITE_ADDR ?>application_form_oc?status2=pending" class="btn btn-primary">Pending</a>
            <a href="<?php echo SITE_ADDR ?>application_form_oc?status2=reverted" class="btn btn-danger">Reverted</a>
            <a href="<?php echo SITE_ADDR ?>application_form_oc?status2=completed" class="btn btn-success">Completed</a>
            <a href="<?php echo SITE_ADDR ?>application_form_oc?status2=paypend" class="btn btn-warning">Payment Pending</a>
        </center>
        <?php } ?>
        <div  class="">
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="application_form_oc-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
                                    ...
                                    <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bg-light p-2 mb-3 animated bounceIn">
                                                ...
                                                <span>
                                                    <?php 
                                                    $id = $data['id'];                                                                                                echo "<a href='".SITE_ADDR."api/viewreasonALL/$id/oc' class='btn btn-danger page-modal modal-page btn-sm'>VIEW AUTHORITY REMARKS</a><br>"; 

                                                    $addBtn = "";
                                                    $viewBtn = "";
                                                    $submitBtn = "";
                                                    $dbname="oc";
                                                    if($data['upload_cc_certificate']==""){
                                                        
                                                                                                if($data['status']+0>=2){ 
                                                                                                    if(USER_ROLE != '2'){
                                                                                                        echo "<a href='".SITE_ADDR."information_of_plan_oc/?rec_id=$id' class='btn btn-warning btn-sm'>🔍  VIEW INSPECTION</a><br>";
                                                                                                    }
  ...
  if(USER_ROLE==4){
                                                                             ...
                                                                             echo "<a href='".SITE_ADDR."accept_reject/add/?rec_id=$id&action=REVERT&db_name=oc' class='btn btn-danger btn-sm'>REVERT</a>";

                                                                                    echo "<a href='" . SITE_ADDR . "information_of_plan_oc/add/?rec_id=" . $id . "&application_no=" . $data['application_no'] . "' class='btn btn-danger btn-sm'>DO INSPECTION</a>";
                                                                                    // ✅ Check if at least one plan detail exists
                                                                                    $jei = new User_infoController();
                                                                                    $db = $jei->GetModel();
                                                                                    $db->where("rec_id", $id);
                                                                                    $hasPlanDetails = $db->has("information_of_plan_oc"); // true/false
                                                                                    // ✅ Show Accept/Reject only if details are present
                                                                                    if($hasPlanDetails){
                                                                                    echo "<a href='".SITE_ADDR."accept_reject/add/?rec_id=$id&db_name=oc' class='btn btn-danger btn-sm'>ACCEPT / REJECT</a>";
                                                                                    }
                                                                                    }
                                                                                }
                                                        ...
                                                        if(USER_ROLE != '2'){
                                                            echo "<a href='".SITE_ADDR."information_of_plan/?oc=$id' class='btn btn-warning btn-sm'>🔍  VIEW INSPECTION</a><br>";
                                                        }
                                                    ...
                                                    echo '<br><span style="font-weight: bold; background-color: yellow; padding: 2px 5px; color: black; border-radius: 3px;">COMPLETED</span><br>';
                                                        ...
                                                        echo '<span style="font-weight: bold; background-color: yellow; color: black; padding: 2px 5px; border-radius: 3px;">PENDING NOC UPLOAD</span><br>';
                                                            ...
                                                            $viewBtn = "<a href='".SITE_ADDR."water_form_details_oc/?rec_id=$id' class='btn btn-info btn-sm'>💧 VIEW WATER DETAILS</a><br>";
                                                                $addBtn  = "<a href='".SITE_ADDR."water_form_details_oc/add?rec_id=$id&application_no=".$data['application_no']."' class='btn btn-danger btn-sm'>➕ ADD WATER DETAILS</a>";
                                                                // ✅ Check if at least one water detail exists
                                                                $jei = new User_infoController();
                                                                $db = $jei->GetModel();
                                                                $db->where("rec_id", $id);
                                                                $hasWaterDetails = $db->has("water_form_details_oc"); // true/false
                                                                if($data['status']+0==0){
                                                                ...
                                                                echo '<span style="font-weight: bold; background-color: yellow; color: black; padding: 2px 5px; border-radius: 3px;">FIRST ADD THE WATER DETAILS</span><br>';
                                                                    ...
                                                                    echo $addBtn . "<br>" . $viewBtn; 
                                                                        ...
                                                                        if($hasWaterDetails){
                                                                        echo "<a href='".SITE_ADDR."application_form_oc/edit2/$id' class='btn btn-success btn-sm'>SUBMIT FORM</a>";
                                                                        }
                                                                        } else {
                                                                        echo $viewBtn; 
                                                                        }
                                                                        ...
                                                                        echo '<br><span style="font-weight: bold; background-color: red; padding: 2px 5px; border-radius: 3px;">REJECTED</span><br>'; 
                                                                            ...
                                                                            if($data['status']+0==-2){ 
                                                                            echo '<br><span style="font-weight: bold; background-color: red; padding: 2px 5px; border-radius: 3px; color: white;">REVERTED</span><br>'; 
                                                                            if(USER_ROLE == 2){
                                                                                echo "<br><br><a href='".SITE_ADDR."application_form_oc/edit/".$data['id']."' class='btn btn-danger btn-sm'>EDIT APPLICATION</a>"; 
                                                                                    } 
                                                                                echo "<a href='" . SITE_ADDR . "api/viewreason/application_form_oc/" . $id . "' class='btn btn-primary modal-page page-modal btn-sm'>VIEW REASON</a>";
                                                                                }
                                                                                if($data['status']+0==1){
                                                                                ...
                                                                                echo '<br><span style="font-weight: bold; background-color: yellow; padding: 2px 5px; color: black; border-radius: 3px;">PENDING AT AUTH 1</span><br>';
                                                                                    ...
                                                                                    //     echo "<a href='".SITE_ADDR."accept_reject/add/?db_name=$dbname&rec_id=$id' class='btn btn-danger btn-sm'>ACCEPT / REJECT</a>";
                                                                                    //  }
                                                                                    if(USER_ROLE==4 && $data['upload_cc_certificate']!=""){
                                                                                    // ✅ First show "ADD DETAILS" always
                                                                                    echo "<a href='".SITE_ADDR."accept_reject/add/?db_name=$dbname&rec_id=$id' class='btn btn-danger btn-sm'>ACCEPT / REJECT</a>";
                                                                                    }
                                                                                    }
                                                                                    ...
                                                                                    echo '<span style="font-weight: bold; background-color: yellow; padding: 2px 5px; color: black;  border-radius: 3px;">PENDING AT AUTH 2</span><br>';
                                                                                        ...
                                                                                        if($data['paid']==0){
                                                                                        echo "<a href='".SITE_ADDR."../payment_gateway/?proj=WATER_TECHNICAL&service=water_technical_noc_application_form2&amount=5000&id=".$data['id']."&checksum=".hash("sha256",date("YmdHis")."WATER_TECHNICAL".$_GET['amount'])."' class='btn btn-danger btn-sm'>MAKE PAYMENT (Rs. 5000)</a>";
                                                                                        ...
                                                                                        // echo "<a href='".SITE_ADDR."payments/add/?rec_id=$id&amount=5000' class='btn btn-danger btn-sm'>ADD PAYMENT DETAILS</a>";
                                                                                            ...
                                                                                            if(USER_ROLE==5){ 
                                                                                            if($data['paid']==0){
                                                                                            // echo "<a href='".SITE_ADDR."payments/add/?db_name=$dbname&rec_id=$id&amount=5000' class='btn btn-danger btn-sm'>ADD PAYMENT DETAILS</a>";
                                                                                            echo "<a href='".SITE_ADDR."accept_reject/add/?db_name=$dbname&rec_id=$id?action=REJECT' class='btn btn-danger btn-sm'>  REJECT</a>";
                                                                                            }
                                                                                            ...
                                                                                            /*echo '<span style="font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px;">Pending NOC Upload</span><br>';*/
                                                                                                ...
                                                                                                echo "<a href='".SITE_ADDR."application_form_oc/generate_noc/$id' class='btn btn-warning btn-sm'>GENERATE NOC</a> ";
                                                                                                echo "<a href='".SITE_ADDR."application_form_oc/edit_approval/$id' class='btn btn-danger btn-sm'>UPLOAD NOC</a>";
                                                                                                }
                                                                                                }
                                                                                                if($data['status']+0==5){
                                                                                                ...
                                                                                                <br>
                                                                                                    ...
                                                                                                    <div class="mb-2">  
                                                                                                        <span class="font-weight-light text-muted ">
                                                                                                            LANDOWNER OR APPLICANT NAME:  
                                                                                                        </span>
                                                                                                    <?php echo $data['landowner_or_applicant_name']; ?></div>
                                                                                                    <div class="mb-2">  
                                                                                                        <span class="font-weight-light text-muted ">
                                                                                                            LICENSED ARCHITECT OR ENGINEERS NAME:  
                                                                                                        </span>
                                                                                                    ...
                                                                                                    <div class="mb-2">  
                                                                                                        <span class="font-weight-light text-muted ">
                                                                                                            ARE ALL CONNECTIONS DISCONNECTED ON SITE FROM MAIN LINE?:  
                                                                                                        </span>
                                                                                                    <?php echo $data['are_all_connections_disconnected_on_site_from_main_line']; ?></div>
                                                                                                    <div class="mb-2">  
                                                                                                        <span class="font-weight-light text-muted ">
                                                                                                            IS SEWAGE TREATMENT PLANT PROPOSED FOR THE PROPOSAL?:  
                                                                                                        </span>
                                                                                                    ...
                                                                                                    <?php endif; ?>
                                                                                                    <?php if (!empty($data['upload_declaration_certificate'])): ?>
                                                                                                    <div class="mb-2">
                                                                                                        <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                                                            UPLOADED DECLARATION LETTER:
                                                                                                        </strong>  
                                                                                                        <a href="<?php echo htmlspecialchars($data['upload_declaration_certificate'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                                                            target="_blank" 
                                                                                                            class="btn btn-info btn-sm">
                                                                                                            View Document
                                                                                                        </a>
