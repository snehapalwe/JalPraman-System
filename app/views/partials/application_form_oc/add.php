...
echo "New applications are not allowed w.e.f. 24/02/2026 17.30 PM";
exit();
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>ADD NEW WATER TECHNICAL NOC APPLICATION OC</strong></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="myForm" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("application_form_oc/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                
                                <!--<a id='saveBtn' class='btn btn-primary' style="float:right;color:white">SAVE</a>-->
                                <div class="form-group ">
                                    <label class="control-label" for="cc_number">CC NUMBER<span class="text-danger">*</span></label>
                                    <div id="ctrl-cc_number-holder" class="">  
                                        <input id="ctrl-cc_number"  value="<?php  echo $rec['application_no'] ?>" <?php  echo $rec['id']>0?"readonly":"" ?> type="text" placeholder="Enter CC NUMBER"  required="" name="cc_number"  class="form-control " />
                                        </div>
                                    </div> 
                                ...
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-ward-holder" class=""> 
                                        <select required=""  id="ctrl-ward" name="ward"  placeholder="Select a value ..."    class="custom-select" >
                                            ...
                                            <?php 
                                            $ward_options = $comp_model -> application_form_oc_ward_option_list_2();
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <label class="control-label" for="licensed_architect_or_engineers_name">LICENSED ARCHITECT OR ENGINEERS NAME <span class="text-danger">*</span></label>
                                        <div id="ctrl-licensed_architect_or_engineers_name-holder" class=""> 
                                            <input id="ctrl-licensed_architect_or_engineers_name"  value="<?php  echo $this->set_field_value('licensed_architect_or_engineers_name',""); ?>" type="text" placeholder="Enter LICENSED ARCHITECT OR ENGINEERS NAME"  required="" name="licensed_architect_or_engineers_name"  class="form-control " />
                                            </div>
                                        </div>
                                    <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <fieldset><legend style = "color:BLACK; font-weight:BOLD; font-size:18px;">INFORMATION OF BUILDING PROPOSAL AS PER PLANS ATTACHED</legend>
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <label class="control-label" for="proposed_quantity_of_residences">PROPOSED WATER REQUIREMENT FOR RESIDENCES (IN LITRE) <span class="text-danger">*</span></label>
                                                                    <div id="ctrl-proposed_quantity_of_residences-holder" class=""> 
                                                                        <input id="ctrl-proposed_quantity_of_residences"  value="<?php  echo $this->set_field_value('proposed_quantity_of_residences',""); ?>" type="number" placeholder="Enter PROPOSED WATER REQUIREMENT FOR RESIDENCES (IN LITRE)" step="1"  required="" name="proposed_quantity_of_residences"  class="form-control " />
                                                                        </div>
                                                                        <small class="form-text"><span class='text-danger'>Enter Only the Numeric Value</span></small>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        <label class="control-label" for="proposed_quantity_of_shops">PROPOSED WATER REQUIREMENT FOR SHOPS (IN LITRE) <span class="text-danger">*</span></label>
                                                                        <div id="ctrl-proposed_quantity_of_shops-holder" class=""> 
                                                                            <input id="ctrl-proposed_quantity_of_shops"  value="<?php  echo $this->set_field_value('proposed_quantity_of_shops',""); ?>" type="number" placeholder="Enter PROPOSED WATER REQUIREMENT FOR SHOPS (IN LITRE)" step="1"  required="" name="proposed_quantity_of_shops"  class="form-control " />
                                                                            </div>
                                                                            <small class="form-text"><span class='text-danger'>Enter Only the Numeric Value</span></small>
                                                                        </div>
                                                                        <div class="form-group ">
                                                                            <label class="control-label" for="proposed_quantity_of_offices">PROPOSED WATER REQUIREMENT FOR OFFICES (IN LITRE) <span class="text-danger">*</span></label>
                                                                            <div id="ctrl-proposed_quantity_of_offices-holder" class=""> 
                                                                                <input id="ctrl-proposed_quantity_of_offices"  value="<?php  echo $this->set_field_value('proposed_quantity_of_offices',""); ?>" type="number" placeholder="Enter PROPOSED WATER REQUIREMENT FOR OFFICES (IN LITRE)" step="1"  required="" name="proposed_quantity_of_offices"  class="form-control " />
                                                                                </div>
                                                                                <small class="form-text"><span class='text-danger'>Enter Only the Numeric Value</span></small>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                <label class="control-label" for="total">TOTAL QUANTITY OF WATER REQUIRED (IN LITRE)  <span class="text-danger">*</span></label>
                                                                                <div id="ctrl-total-holder" class=""> 
                                                                                    <input id="ctrl-total"  value="<?php  echo $this->set_field_value('total',""); ?>" type="text" placeholder="Enter TOTAL QUANTITY OF WATER REQUIRED (IN LITRE) "  readonly required="" name="total"  class="form-control " />
                                                                                    </div>
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <div id="ctrl-length_of_ug_tank_proposed-holder" class=""> 
                                                                                        <input id="ctrl-length_of_ug_tank_proposed"  value="<?php  echo $this->set_field_value('length_of_ug_tank_proposed',""); ?>" type="number" placeholder="Enter LENGTH OF UG TANK PROPOSED" step="0.001"  required="" name="length_of_ug_tank_proposed"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div id="ctrl-width_of_ug_tank_proposed-holder" class=""> 
                                                                                            <input id="ctrl-width_of_ug_tank_proposed"  value="<?php  echo $this->set_field_value('width_of_ug_tank_proposed',""); ?>" type="number" placeholder="Enter WIDTH OF UG TANK PROPOSED" step="0.001"  required="" name="width_of_ug_tank_proposed"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div id="ctrl-depth_of_ug_tank_proposed-holder" class=""> 
                                                                                                <input id="ctrl-depth_of_ug_tank_proposed"  value="<?php  echo $this->set_field_value('depth_of_ug_tank_proposed',""); ?>" type="number" placeholder="Enter DEPTH OF UG TANK PROPOSED" step="0.001"  required="" name="depth_of_ug_tank_proposed"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div id="ctrl-length_of_oh_tank_proposed-holder" class=""> 
                                                                                                        <input id="ctrl-length_of_oh_tank_proposed"  value="<?php  echo $this->set_field_value('length_of_oh_tank_proposed',""); ?>" type="number" placeholder="Enter LENGTH OF OH TANK PROPOSED" step="0.001"  required="" name="length_of_oh_tank_proposed"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-group ">
                                                                                                        ...
                                                                                                        <div id="ctrl-width_of_oh_tank_proposed-holder" class=""> 
                                                                                                            <input id="ctrl-width_of_oh_tank_proposed"  value="<?php  echo $this->set_field_value('width_of_oh_tank_proposed',""); ?>" type="number" placeholder="Enter WIDTH OF OH TANK PROPOSED" step="0.001"  required="" name="width_of_oh_tank_proposed"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div id="ctrl-height_of_oh_tank_proposed-holder" class=""> 
                                                                                                                <input id="ctrl-height_of_oh_tank_proposed"  value="<?php  echo $this->set_field_value('height_of_oh_tank_proposed',""); ?>" type="number" placeholder="Enter HEIGHT OF OH TANK PROPOSED" step="0.001"  required="" name="height_of_oh_tank_proposed"  class="form-control " />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div id="ctrl-size_and_capcity_of_oh_tank_proposed-holder" class=""> 
                                                                                                                    <input id="ctrl-size_and_capcity_of_oh_tank_proposed"  value="<?php  echo $this->set_field_value('size_and_capcity_of_oh_tank_proposed',""); ?>" type="text" placeholder="Enter SIZE AND CAPACITY OF OH TANK PROPOSED (IN LITRE)"  readonly required="" name="size_and_capcity_of_oh_tank_proposed"  class="form-control " />
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="form-group ">
                                                                                                                    <label class="control-label" for="distance_of_ug_tank_from_supply_line">DISTANCE OF UG TANK FROM SUPPLY LINE (IN METRE) <span class="text-danger">*</span></label>
                                                                                                                    <div id="ctrl-distance_of_ug_tank_from_supply_line-holder" class=""> 
                                                                                                                        <input id="ctrl-distance_of_ug_tank_from_supply_line"  value="<?php  echo $this->set_field_value('distance_of_ug_tank_from_supply_line',""); ?>" type="text" placeholder="Enter DISTANCE OF UG TANK FROM SUPPLY LINE (IN METRE)"  required="" name="distance_of_ug_tank_from_supply_line"  class="form-control " />
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                    <?php if(!isset($rec['id'])){
                                                                                                                    ?>
                                                                                                                    <div class="form-group  ">
                                                                                                                        <label class="control-label" for="upload_cc_certificate">UPLOAD CC CERTIFICATE <span class="text-danger">*</span></label>
                                                                                                                        <div id="ctrl-upload_cc_certificate-holder" class=""> 
                                                                                                                            <div class="dropzone required" input="#ctrl-upload_cc_certificate" fieldname="upload_building_plan"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.jpeg,.pdf" filesize="3" maximum="1">
                                                                                                                                <input name="upload_cc_certificate" id="ctrl-upload_cc_certificate" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('upload_cc_certificate',""); ?>" type="text"  />
                                                                                                                    ...
                                                                                                                    <div class="form-group  ">
                                                                                                                        ...
                                                                                                                        <div class="form-group  ">
                                                                                                                            ...
                                                                                                                            <div class="form-group  ">
                                                                                                                                ...
                                                                                                                                <div class="form-group ">
                                                                                                                                    <label class="control-label" for="upload_declaration_certificate">UPLOAD DECLARATION CERTIFICATE <span class="text-danger">*</span></label>
                                                                                                                                    <div id="ctrl-upload_declaration_certificate-holder" class=""> 
                                                                                                                                        <div class="dropzone required" input="#ctrl-upload_declaration_certificate" fieldname="upload_declaration_certificate"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.jpeg,.pdf" filesize="3" maximum="1">
                                                                                                                                            <input name="upload_declaration_certificate" id="ctrl-upload_declaration_certificate" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('upload_declaration_certificate',""); ?>" type="text"  />
                                                                                                                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                        <small class="form-text"><span class='text-danger' style='font-weight: bold;'>UPLOAD SIGNED DOCUMENT OF LICENCED PLUMBER & BUILDER, & DEVELOPER</span></small>
                                                                                                                                    </div>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const form = document.getElementById("myForm");     // change to your form id
    const submitBtn = document.getElementById("btnSubmit"); // change to your button id

    submitBtn.addEventListener("click", () => {

        // run native html5 validation
        if (!form.checkValidity()) {
            form.reportValidity();   // show browser error tooltip
            return;                  // stop
        }

        // all required fields ok → force submit
        form.submit();
    });
...
foreach($f as $fx){
    ?>
    <script>
        $("#ctrl-<?php echo $fx ?>").val("<?php echo $rec[$fx] ?>");
        $("#ctrl-<?php echo $fx ?>").prop("readonly",true);
    </script>
    <?php
}
}
