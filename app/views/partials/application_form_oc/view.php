...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Application Form Oc</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-ward">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/application_form_oc_ward_option_list'); ?>' 
                                                data-value="<?php echo $data['ward']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="ward" 
                                    ...
                                    <tr  class="td-licensed_architect_or_engineers_name">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['licensed_architect_or_engineers_name']; ?>" 
                                                ...
                                                data-title="Enter LICENSED ARCHITECT OR ENGINEERS NAME" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-upload_detailed_location_plan">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['upload_detailed_location_plan']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="upload_detailed_location_plan" 
                                                data-title="Browse..." 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                ...
                                                data-showbuttons="left" 
                                                class="is-editable" <?php } ?>>
                                                <?php echo $data['upload_detailed_location_plan']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr  class="td-proposed_quantity_of_residences">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['proposed_quantity_of_residences']; ?>" 
                                                ...
                                                data-title="Enter PROPOSED WATER REQUIREMENT FOR RESIDENCES (IN LITRE)" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="number" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-proposed_quantity_of_shops">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['proposed_quantity_of_shops']; ?>" 
                                                ...
                                                data-title="Enter PROPOSED WATER REQUIREMENT FOR SHOPS (IN LITRE)" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="number" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-proposed_quantity_of_offices">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['proposed_quantity_of_offices']; ?>" 
                                                ...
                                                data-title="Enter PROPOSED WATER REQUIREMENT FOR OFFICES (IN LITRE)" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="number" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-total">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['total']; ?>" 
                                                ...
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="total" 
                                                data-title="Enter TOTAL QUANTITY OF WATER REQUIRED (IN LITRE) " 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-length_of_ug_tank_proposed">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['length_of_ug_tank_proposed']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-width_of_ug_tank_proposed">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['width_of_ug_tank_proposed']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-depth_of_ug_tank_proposed">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['depth_of_ug_tank_proposed']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-length_of_oh_tank_proposed">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['length_of_oh_tank_proposed']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-width_of_oh_tank_proposed">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['width_of_oh_tank_proposed']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-height_of_oh_tank_proposed">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-step="0.001" 
                                                data-value="<?php echo $data['height_of_oh_tank_proposed']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-distance_of_ug_tank_from_supply_line">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['distance_of_ug_tank_from_supply_line']; ?>" 
                                                ...
                                                data-title="Enter DISTANCE OF UG TANK FROM SUPPLY LINE (IN METRE)" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-upload_declaration_certificate">
                                        <th class="title"> Upload Declaration Certificate: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['upload_declaration_certificate']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("application_form_oc/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="upload_declaration_certificate" 
                                                data-title="Browse..." 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                ...
                                                data-showbuttons="left" 
                                                class="is-editable" <?php } ?>>
                                                <?php echo $data['upload_declaration_certificate']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                </tbody>
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <?php if($can_edit){ ?>
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("application_form_oc/edit/$rec_id"); ?>">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <?php } ?>
                                                <?php if($can_delete){ ?>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("application_form_oc/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
