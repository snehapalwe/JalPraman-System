                                ...
                                <input id="ctrl-rec_id"  value="<?php  echo $this->set_field_value('rec_id',""); ?>" type="hidden" placeholder="Enter Rec Id"  required="" name="rec_id"  class="form-control " />
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-amount-holder" class=""> 
                                            <input id="ctrl-amount"  value="<?php  echo $this->set_field_value('amount',""); ?>" type="text" placeholder="Enter AMOUNT (SCRUTINY FEES)"  readonly required="" name="amount"  class="form-control " />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-payment_person-holder" class=""> 
                                                <input id="ctrl-payment_person"  value="<?php  echo $this->set_field_value('payment_person',""); ?>" type="text" placeholder="Enter Payment Person's Name"  required="" name="payment_person"  class="form-control " />
                                                </div>
                                            </div>
                                            <input id="ctrl-db_name"  value="<?php  echo $this->set_field_value('db_name',"cc"); ?>" type="hidden" placeholder="Enter Db Name"  name="db_name"  class="form-control " />
                                            </div>
