...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>ADD WATER DETAILS</strong></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="water_form_details-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("water_form_details/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-diameter-holder" class=""> 
                                                    <input id="ctrl-diameter"  value="<?php  echo $this->set_field_value('diameter',""); ?>" type="number" placeholder="Enter DIAMETER (MM)" step="0.01"  required="" name="diameter"  class="form-control " />
                                                    </div>
                                                </div>
                                                <div class="form-group ">
